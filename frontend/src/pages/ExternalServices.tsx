...
const ExternalServices: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingService) {
        await externalServiceService.update(editingService._id, {
          name: formData.name,
                  ...
                  {siteServices.map((service) => (
                    <div key={service._id} className="service-card">
                      ...
                      <div className="service-actions">
                        <button
                          className="btn-test"
                          onClick={() => handleTestConnection(service._id)}
                          disabled={testingServiceId === service._id}
                        >
                          {testingServiceId === service._id
                            ? '🔄 Probando...'
                            : '🔌 Probar Conexión'}
                        </button>
